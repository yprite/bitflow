...
export function IndicatorCard({
  ...
  return (
    <div className="border-t border-dot-border flex items-center justify-between py-4">
      <div>
        <div className="text-[14px] text-dot-text">{label}</div>
        <div className="text-[11px] text-dot-muted">{labelEn}</div>
      </div>
      <div className="text-right">
        <div className={`text-[20px] font-bold ${colorClass}`}>
